...
inline constexpr GameMeta::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : last_updated_{::uint64_t{0u}},
        _initialized_{false},
        mode_{static_cast< ::ModeType >(0)},
        grid_size_{::uint64_t{0u}},
        _cached_size_{0} {}
...
const ::uint32_t
    TableStruct_game_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::GameMeta, _impl_.last_updated_),
        PROTOBUF_FIELD_OFFSET(::GameMeta, _impl_.mode_),
        PROTOBUF_FIELD_OFFSET(::GameMeta, _impl_.grid_size_),
        ~0u,  // no _has_bits_
        ...
        PROTOBUF_FIELD_OFFSET(::GameState, _impl_.time_to_think_ns_),
};
...
const char descriptor_table_protodef_game_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\ngame.proto\"\007\n\005Empty\"b\n\010GameMeta\022\024\n\014_in"
    "itialized\030\001 \001(\010\022\024\n\014last_updated\030\002 \001(\004\022\027\n"
    "\004mode\030\003 \001(\0162\t.ModeType\022\021\n\tgrid_size\030\004 \001("
    "\004\"\201\001\n\tGameState\022\r\n\005board\030\001 \001(\014\022\023\n\013p1_cap"
    "tures\030\002 \001(\004\022\023\n\013p0_captures\030\003 \001(\004\022\021\n\tnum_"
    "turns\030\004 \001(\004\022\016\n\006is_end\030\005 \001(\010\022\030\n\020time_to_t"
    "hink_ns\030\006 \001(\004*F\n\010ModeType\022\017\n\013AI_STANDARD"
    "\020\000\022\n\n\006AI_PRO\020\001\022\020\n\014PVP_STANDARD\020\002\022\013\n\007PVP_"
    "PRO\020\0032\300\001\n\004Game\022\"\n\013GetGameMeta\022\006.Empty\032\t."
    "GameMeta\"\000\022\"\n\013SetGameMeta\022\t.GameMeta\032\006.E"
...
const ::_pbi::TcParseTable<2, 4, 0, 0, 2> GameMeta::_table_ = {
  {
    ...
    // uint64 grid_size = 4;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(GameMeta, _impl_.grid_size_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.grid_size_)}},
    // bool _initialized = 1;
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(GameMeta, _impl_.last_updated_), 63>(),
     {16, 63, 0, PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.last_updated_)}},
    // .ModeType mode = 3;
    ...
    // uint64 last_updated = 2;
    {PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.last_updated_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUInt64)},
    // .ModeType mode = 3;
    {PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.mode_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // uint64 grid_size = 4;
    {PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.grid_size_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
...
// @@protoc_insertion_point(message_clear_start:GameMeta)
  ...
  ::memset(&_impl_.last_updated_, 0, static_cast<::size_t>(
      ...
      reinterpret_cast<char*>(&_impl_.last_updated_)) + sizeof(_impl_.grid_size_));
...
::uint8_t* GameMeta::_InternalSerialize(
  ...
  if (this->_internal_last_updated() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
        2, this->_internal_last_updated(), target);
  }
  ...
  // uint64 grid_size = 4;
  if (this->_internal_grid_size() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
        4, this->_internal_grid_size(), target);
  }
...
void GameMeta::InternalSwap(GameMeta* PROTOBUF_RESTRICT other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.grid_size_)
      + sizeof(GameMeta::_impl_.grid_size_)
      - PROTOBUF_FIELD_OFFSET(GameMeta, _impl_.last_updated_)>(
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 6, 0, 0, 2> GameState::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(GameState, _impl_.time_to_think_ns_), 63>(),
     {48, 63, 0, PROTOBUF_FIELD_OFFSET(GameState, _impl_.time_to_think_ns_)}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
  }}, {{
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kBool)},
    // uint64 time_to_think_ns = 6;
    {PROTOBUF_FIELD_OFFSET(GameState, _impl_.time_to_think_ns_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
...
::uint8_t* GameState::_InternalSerialize(
  ...
  // uint64 time_to_think_ns = 6;
  if (this->_internal_time_to_think_ns() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
        6, this->_internal_time_to_think_ns(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:GameState)
  ...
  if (this->_internal_time_to_think_ns() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(
        this->_internal_time_to_think_ns());
  }
...
void GameState::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (from._internal_time_to_think_ns() != 0) {
    _this->_impl_.time_to_think_ns_ = from._impl_.time_to_think_ns_;
  }
