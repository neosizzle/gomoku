...
/* @@protoc_insertion_point(class_definition:GameMeta) */ {
 ...
 public:
  ...
  void set_gridsize(::uint64_t value);

  private:
  ::uint64_t _internal_gridsize() const;
  void _internal_set_gridsize(::uint64_t value);
...
// uint64 gameId = 2;
inline void GameMeta::clear_gameid() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.gameid_ = ::uint64_t{0u};
}
inline ::uint64_t GameMeta::gameid() const {
  // @@protoc_insertion_point(field_get:GameMeta.gameId)
  return _internal_gameid();
}
inline void GameMeta::set_gameid(::uint64_t value) {
  _internal_set_gameid(value);
  // @@protoc_insertion_point(field_set:GameMeta.gameId)
}
inline ::uint64_t GameMeta::_internal_gameid() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.gameid_;
}
inline void GameMeta::_internal_set_gameid(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
// uint64 gridSize = 4;
inline void GameMeta::clear_gridsize() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.gridsize_ = ::uint64_t{0u};
}
inline ::uint64_t GameMeta::gridsize() const {
  // @@protoc_insertion_point(field_get:GameMeta.gridSize)
  return _internal_gridsize();
}
inline void GameMeta::set_gridsize(::uint64_t value) {
  _internal_set_gridsize(value);
  // @@protoc_insertion_point(field_set:GameMeta.gridSize)
}
inline ::uint64_t GameMeta::_internal_gridsize() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.gridsize_;
}
inline void GameMeta::_internal_set_gridsize(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
